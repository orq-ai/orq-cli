...
func registerknowledgeBasesCommands(root *cobra.Command) {
	...
	func() {
		...
		examples += "  " + parent.CommandPath() + " preview-chunks knowledge-id --example\n"
