...
func registermcpServersCommands(root *cobra.Command) {
	...
	func() {
		...
		examples += "  " + mcpServersCmd.CommandPath() + " test --example\n"
					...
					[]bartolocli.BodyField{
						{
							...
							FlagName:    "auth",
							Type:        "json",
							Description: "Credentials to probe with. Omit when `id` is set.",
						},
						{
							Name:        "connection",
							FlagName:    "connection",
							Type:        "json",
							Description: "Connection to probe. Omit when `id` is set.",
						},
						{
							Name:        "discovery_variables",
							FlagName:    "discovery-variables",
						...
						},
						{
							...
							FlagName:    "id",
							Type:        "string",
							Description: "Probe a stored server instead of sending `connection` and `auth`.",
						},
					},
				)
				if err != nil {
