				...
				body, err := bartolocli.GetBodyWithFlags(cmd, "application/json", args[0:], params,
					[]bartolocli.BodyField{
						...
						},
						{
							...
							FlagName:    "model",
							Type:        "string",
							Description: "ID of the classify model to use, for example typesafe/jev-latest.",
						},
						{
							Name:        "name",
							FlagName:    "name",
