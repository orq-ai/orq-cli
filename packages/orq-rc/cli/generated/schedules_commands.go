...
func registerschedulesCommands(root *cobra.Command) {
	...
	func() {
		...
		examples += "  " + schedulesCmd.CommandPath() + " create agent-key display_name: Ticket status update, expression: @at 2026-05-01T09:00:00Z, payload.input: @file, type: once\n"
		...
		cmd := &cobra.Command{
			...
			Run: func(cmd *cobra.Command, args []string) {
				body, err := bartolocli.GetBody("application/json", args[1:], params, []string{
					"display_name: Ticket status update, expression: @at 2026-05-01T09:00:00Z, payload.input: @file, type: once",
				})
				if err != nil {
